                ...
                <div class="inner">
                    ...
                    <div class="search_box">
                        ...
                        <form action="" method="">
                            ...
                            <button type="button">
                                <img src="./assets/images/search_icon.png" alt="돋보기 검색 아이콘" />
                            </button>
                        </form>
                    </div>
                </div>
            ...
            <article class="book_area best_book">
                <div class="inner">
                    ...
                    <div class="book_inner">
                        <div class="book_box">
                            <a href="#">
                                <img src="./assets/images/01.jpg" alt="책 표지">
                        ...
                        <div class="book_box">
                            <a href="#">
                                <img src="./assets/images/02.jpg" alt="책 표지">
                                <h4>불편한 편의점 2</h4>
                                <p>김호연</p>
                            </a>
                        </div>
                        <div class="book_box">
                            <a href="#">
                                <img src="./assets/images/03.jpg" alt="책 표지">
                        ...
                        <div class="book_box">
                            <a href="#">
                                <img src="./assets/images/04.jpg" alt="책 표지">
                        ...
                        <div class="book_box">
                            <a href="#">
                                <img src="./assets/images/05.jpg" alt="책 표지">
                                <h4>마법천자문 57</h4>
                                <p>유대영</p>
                            </a>
                        </div>
            ...
            <article class="inner">
                ...
                <form class="signup_form" action="" method="">
                    <ul>
                        ...
                        <li class="sex_input">
                            <h4>성별</h4>
                            <input type="hidden" name="user_gender" value="남성" />
                        ...
                        <li>
                            <h4>생년월일</h4>
                            <input type="text" placeholder="6자리 숫자로 입력하세요." />
                            <p class="on">※ 작성오류 문구</p>
                        </li>
                    </ul>
