...
//		}
	...
	@RequestMapping(value = "my/recommend", method = RequestMethod.GET)
	public ModelAndView recommend(ModelAndView mav, HttpSession session) {
		
		AuthInfo authInfo = (AuthInfo)session.getAttribute("authInfo");
		UserDTO dto = userService.selectUserProcess(authInfo.getUser_id());
		int age = dto.getUser_age();
		//가져온 dto에서 성별나이가 필요하다 
		
		String paramAge = "0";
		
		String sex = dto.getUser_sex();
		String gender = "0";
