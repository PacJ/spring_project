...
public class FileUpload {
	...
	//사진첨부가 저장될 위치 설정 (/resources/image)
	public static String urlPathImg(HttpServletRequest request) {
		//서버에 저장할 위치값
		String rootImg = request.getSession().getServletContext().getRealPath("/resources/");
		String saveDirectoryImg = rootImg + "images" + File.separator;
